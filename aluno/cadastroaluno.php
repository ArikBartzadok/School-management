                                    ...
                                    <div class="card-body card-block">
                                        <form method="POST" action="bdcadaluno.php">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="nome" id="nf-email" placeholder="Nome do aluno" class="form-control">
                                            </div>
                                            <div class="form-group">
                                                <label for="nf-email" class=" form-control-label">RG</label>
                                                <input type="text" name="rg" id="nf-email" placeholder="RG do aluno" class="form-control">
                                            </div>
                                            <div class="form-group">
                                                <label for="nf-email" class=" form-control-label">RA</label>
                                                <input type="text" name="ra" id="nf-email" placeholder="RA do aluno" class="form-control">
                                            </div>
                                            <div class="form-group">
                                                <label for="nf-email" class=" form-control-label">Endereço</label>
                                                <input type="text" name="endereco" id="nf-email" placeholder="Endereço do aluno" class="form-control">
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="email" id="nf-email" placeholder="E-Mail do aluno" class="form-control">                                                
                                            </div>
                                            <div class="form-group">
                                                <label for="nf-email" class=" form-control-label">Telefone</label>
                                                <input type="text" name="telefone" id="nf-email" placeholder="Telefone do aluno." class="form-control">                                                
                                            </div>
