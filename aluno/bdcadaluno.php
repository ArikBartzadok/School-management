        ...
        <div class="page-container">
			...
			<?php
				...
				{                    
                    ...
                    echo "<div class='row'><div class='col-md-12'><a href='cadastroaluno.php'><button type='button' class='btn btn-danger'><i class='fa fa-reply'></i>&nbsp; Corrigir</button><button type='button' class='btn btn-link'></a></div></div><br/><br/>";                
				}
				else{
					$sql = "insert into aluno values (null, '$nome', '$rg', '$ra', '$endereco', '$cidade','$email', '$telefone')";
					$result = $mysqli->query($sql );
					echo "<br/><h2>Aluno cadastrado com <span class='badge badge-secondary'>sucesso!</span> </h2><br/>";
				}
