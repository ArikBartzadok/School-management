                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <h2 class="title-1">Sistema de Cadastro de Funcionário</h2>
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    ...
                                    <div class="card-body card-block">
                                        <form method="POST" action="bdcadfunc.php">
                                            <div class="form-group">
                                                <label for="nf-email" class=" form-control-label">Nome</label>
                                                <input type="text" name="nome" id="nf-email" placeholder="Nome do funcionário" class="form-control">
                                            </div>
                                            <div class="form-group">
                                                <label for="nf-email" class=" form-control-label">RG</label>
                                                <input type="text" name="rg" id="nf-email" placeholder="RG do funcionário" class="form-control">
                                            </div>
                                            <div class="form-group">
                                                <label for="nf-email" class=" form-control-label">CPF</label>
                                                <input type="text" name="cpf" id="nf-email" placeholder="CPF do funcionário" class="form-control">
                                            </div>
                                            <div class="form-group">
                                                <label for="nf-email" class=" form-control-label">Endereço</label>
                                                <input type="text" name="endereco" id="nf-email" placeholder="Endereço do funcionário" class="form-control">
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="email" id="nf-email" placeholder="E-Mail do funcionário" class="form-control">                                                
                                            </div>
                                            <div class="form-group">
                                                <label for="nf-email" class=" form-control-label">Telefone</label>
                                                <input type="text" name="telefone" id="nf-email" placeholder="Telefone do funcionário." class="form-control">                                                
                                            </div>
