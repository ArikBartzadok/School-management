        ...
        <div class="page-container">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="overview-wrap">
                                    <h2 class="title-1">Sistema de Cadastro de Professores</h2>
			...
			<?php
				...
				if($nome == "" or $rg == "" or $cpf == "" or $endereco == "" or $telefone == "" or $cidade == "")
				{
                    ...
                    echo "<div class='row'><div class='col-md-12'><a href='cadastroprof.php'><button type='button' class='btn btn-danger'><i class='fa fa-reply'></i>&nbsp; Corrigir</button><button type='button' class='btn btn-link'></a></div></div><br/><br/>";
				}
				else{
					$sql = "insert into professor values (null, '$nome', '$rg', '$cpf', '$endereco', '$cidade','$email', '$telefone')";
					$result = $mysqli->query($sql );
					echo "<br/><h2>Professor cadastrado com <span class='badge badge-secondary'>sucesso!</span> </h2><br/>";
				}
